    ...
    <div className='flex flex-col text-gray-600'>
      ...
      <div className='flex bg-white rounded-lg w-1/2 p-3 space-x-6'>
        ...
        <div>
          ...
          <p className='text-lg text-gray-400 font-semibold'>smithadams02@gmail.com</p>
        </div>
      </div>
        ...
        <table className='text-gray-500 flex flex-col p-2 h-[20rem]'>
          <thead>
            <tr className='flex bg-indigo-600 text-white m-3 p-3 rounded-xl justify-around space-x-4 text-center my-4'>
              ...
              <th className='w-full flex flex-col space-y-3'>Category</th>
              <th className='w-full flex flex-col space-y-3'>Doctor</th>
